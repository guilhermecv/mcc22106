...
void display_init(void)
{
    TA1CTL = TASSEL_2       // Clock de SMCLK (Subsystem master clock)
           ...
           | ID_1           // prescaler 8
           | TAIE;          // habilita interrup��o

    TA1CCTL0 = CCIE;        // IRQ por compara��o

    TA1CCR1  = 50;          // Valor de compara��o
...
/* ISR0 do Timer A: executado no evento de compara��o  comparador 0 (TACCR0) */
...
#endif
{
    /* Separa os nibles dos dados em fun��o de i */
...
#endif
{
  switch(__even_in_range(TA1IV,0x0A))
  {
      ...
      /* Vector  2:  TACCR1 CCIFG -> Compara��o 1*/
      case  TA1IV_TACCR1:

          break;
      /* Vector  4:  TACCR2 CCIFG -> Compara��o 2*/
      case TA1IV_TACCR2:
          break;
